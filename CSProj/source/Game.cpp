...
//	ps = new CSceneTestSpace;
	...
	MESHFACTORY->registMesh(MESHKEY::TANK01_BOTTOM_1(),	MESHPATH::TANK01_BOTTOM_1()	);
	MESHFACTORY->registMesh(MESHKEY::TANK02_BOTTOM_1(),	MESHPATH::TANK02_BOTTOM_1()	);
	MESHFACTORY->registMesh(MESHKEY::TANK01_BOTTOM_2(),	MESHPATH::TANK01_BOTTOM_2()	);
	MESHFACTORY->registMesh(MESHKEY::TANK02_BOTTOM_2(),	MESHPATH::TANK02_BOTTOM_2()	);
